...
def upgrade():
    ...
    op.add_column('user', sa.Column('preview_length', sa.Integer(), server_default="100", nullable=True))
    op.add_column('user', sa.Column('results_per_page', sa.Integer(), server_default="100", nullable=True))
