...
def upgrade():
    ...
    op.create_index(op.f('ix_rescan_task_complete'), 'rescan_task', ['complete'], unique=False)
    op.create_index(op.f('ix_rescan_task_date_added'), 'rescan_task', ['date_added'], unique=False)
    op.create_index(op.f('ix_rescan_task_date_completed'), 'rescan_task', ['date_completed'], unique=False)
    op.create_index(op.f('ix_rescan_task_date_dispatched'), 'rescan_task', ['date_dispatched'], unique=False)
    op.create_index(op.f('ix_rescan_task_dispatched'), 'rescan_task', ['dispatched'], unique=False)
    op.create_index(op.f('ix_rescan_task_target'), 'rescan_task', ['target'], unique=False)
    op.create_index(op.f('ix_rescan_task_scan_id'), 'rescan_task', ['scan_id'], unique=True)
