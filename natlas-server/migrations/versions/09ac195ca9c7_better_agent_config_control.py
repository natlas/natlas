...
def upgrade():
    ...
    op.add_column('agent_config', sa.Column('scriptTimeout', sa.Integer(), nullable=True))
    with op.batch_alter_table('agent_config') as bop:
        bop.alter_column('defaultScripts', new_column_name='enableScripts')
    
    newColumns = {'hostTimeout':600, 'noPing':False, 'osScanLimit':False, 'scriptTimeout':60}
